...
# # Get the absolute path of the omni_drones directory
# omni_drones_path = os.path.abspath("/home/taka/SimpleFlight/omni_drones")  # Update this path

# # Add it to Python's sys.path
# if omni_drones_path not in sys.path:
#     sys.path.append(omni_drones_path)
