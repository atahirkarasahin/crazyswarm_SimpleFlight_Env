...
class AgentSpec:
    ...
    state_key: Optional[str] = None #"state"
    ...
    def state_spec(self) -> TensorSpec:
        ...
        # print(self._env.observation_spec["agents"]["observation"])
        # print(f"State Key: {self.state_key}")
        # print(f"Available keys: {self._env.observation_spec['agents'].keys()}")

        #return self._env.observation_spec["agents"]["state"]
